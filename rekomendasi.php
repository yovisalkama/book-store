  ...
  <div id="container">
    <div id="header">
      <div class="headerBackground">
        <h1><font color="#ffffff"><br><br><b>&nbsp;&nbsp;CityBooks</font><font color="#ffffff"> Store</font></b></h1>
      </div>
    </div>
  <body>
        ...
        <div class="myCarousel">
            <div class="row">
                <div class="col-sm-12 text-center">
                   <img src="img/logo.jpg" width="128px" height="128px"><br>
                    <h1><b><font color="#f8192e">CityBooks</font> Store</b></h1>
...
<!-- Bagian footer -->
    ...
    <div class="row" style="background: black;">
      <nav class="footer">
            <footer class="copyright text-center"><p>&copy; Copyright CityBooks Store 2020</p></footer>
        </div>
      </nav>
    </div>
</body>
